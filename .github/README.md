...
| ------------------------------------------------ | ----------------------------------------------- |
| ![Homescreen](image/README/homescreen.png)       | ![In action](image/README/in-action.png)        |

| Diff Viewer and Editor                           | Customizer                                      |
| ------------------------------------------------ | ----------------------------------------------- |
| ![Diff viewer](image/README/diff-viewer.png)     | ![Customizer](image/README/customizer.png)      |

| Lorebook Shenanigans                                           | The Lorebook Entry                                 |
| -------------------------------------------------------------- | -------------------------------------------------- |
| ![Lorebook shenanigans](image/README/lorebook-shenanigans.png) | ![Lorebook entry](image/README/lorebook-entry.png) |
