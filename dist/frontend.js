...
Revert those edits to the character now, or leave them applied?`;
  ...
  const adoptStreamingTurn = (assistantMessageId) => state.streamingAssistant ?? createStreamingTurn(assistantMessageId);
  const ensureStreamingTurn = () => state.streamingAssistant ?? createStreamingTurn(makeId("msg"));
